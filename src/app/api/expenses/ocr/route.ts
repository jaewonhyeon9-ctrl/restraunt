...
추출할 정보:
1. supplierName: 가게/거래처 이름 (상단 상호명)
2. date: 영수증 날짜 (YYYY-MM-DD 형식, 없으면 null)
3. items: 모든 품목 배열 (영수증에 적힌 모든 품목을 빠짐없이 포함)
   - name: 품목명
   - quantity: 수량 (숫자)
...
응답 형식:
{
  ...
  "date": "2026-04-16",
  "items": [
    {"name": "품목1", "quantity": 1, "unit": "개", "unitPrice": 1000, "totalPrice": 1000}
  ],
  "total": 10000,
  "rawText": "영수증 전체 텍스트"
}
...
- 합계, 부가세, 할인 등은 items에 포함하지 말 것 (오직 실제 구매 품목만)
